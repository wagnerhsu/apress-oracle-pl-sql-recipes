...
AS
    ...
    rec_count number := 0;
BEGIN
    SELECT count(*) INTO rec_count FROM employees WHERE employee_id = emp_id;
    ...
    IF rec_count = 1 THEN
        ...
        IF emp_row.department_id != dept_id THEN
            ...
            UPDATE employees SET ROW = emp_row WHERE employee_id = emp_id;
            ...
            DBMS_OUTPUT.PUT_LINE('The employee ' || emp_row.first_name || ' ' || emp_row.last_name || ' is now in department: ' || dept);
        ELSE
