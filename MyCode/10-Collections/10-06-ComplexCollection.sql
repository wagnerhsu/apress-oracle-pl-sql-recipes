...
TYPE direct_reports_type
IS
    TABLE OF person_type INDEX BY BINARY_INTEGER;
...
IS
    ...
    CURSOR emp_cursor (mgr_id integer)
    IS -- finds all direct reports for a manager
          SELECT employee_id,
                 first_name,
                 last_name
            FROM employees
